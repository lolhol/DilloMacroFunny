...
public enum Structure {
  QUEEN(
    new ArrayList<Triple<Block, PropertyEnum, Comparable>>() {
      {
    ...
    LocationUtils.Island.CRYSTAL_HOLLOWS,
    CrystalHollowQuarter.GOBLIN_HOLDOUT,
    "§6Queen",
    0,
    5,
    0
  ...
  DIVAN(
    ...
    StructureType.CH_CRYSTALS,
    LocationUtils.Island.CRYSTAL_HOLLOWS,
    CrystalHollowQuarter.MITHRIL_DEPOSITS,
    "§2Divan",
    0,
    5,
    0
  ...
  CITY(
    ...
    StructureType.CH_CRYSTALS,
    LocationUtils.Island.CRYSTAL_HOLLOWS,
    CrystalHollowQuarter.PRECURSOR_REMNANTS,
    "§bCity",
    24,
    0,
    -17
  ...
  BAL(
    ...
    StructureType.CH_CRYSTALS,
    LocationUtils.Island.CRYSTAL_HOLLOWS,
    CrystalHollowQuarter.MAGMA_FIELDS,
    "§6Bal",
    0,
    1,
    0
  ...
  Structure(
    ArrayList<Triple<Block, PropertyEnum, Comparable>> states,
    StructureType structureType,
    LocationUtils.Island island,
    CrystalHollowQuarter crystalHollowQuarter,
    String name,
    int xOffset,
    int yOffset,
    int zOffset
