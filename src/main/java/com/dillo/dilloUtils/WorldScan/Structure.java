package com.dillo.dilloUtils.WorldScan;
...
import com.dillo.dilloUtils.WorldScan.LocationUtils;
...
public enum Structure {
    ...
    }}, StructureType.CH_CRYSTALS, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.GOBLIN_HOLDOUT, "§6Queen", 0, 5, 0),
    ...
    }}, StructureType.CH_CRYSTALS, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.MITHRIL_DEPOSITS, "§2Divan", 0, 5, 0),
    ...
    }}, StructureType.CH_CRYSTALS, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.PRECURSOR_REMNANTS, "§bCity", 24, 0, -17),
    TEMPLE(new ArrayList<Triple<Block, PropertyEnum, Comparable>>() {{
        ...
        add(new Triple<>(Blocks.leaves, null, null));
    }}, StructureType.CH_CRYSTALS, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.JUNGLE, "§5Temple", -45, 47, -18),
    KING(new ArrayList<Triple<Block, PropertyEnum, Comparable>>() {{
        add(new Triple<>(Blocks.wool, null, null));
        add(new Triple<>(Blocks.dark_oak_stairs, null, null));
        add(new Triple<>(Blocks.dark_oak_stairs, null, null));
        add(new Triple<>(Blocks.dark_oak_stairs, null, null));
    }}, StructureType.CH_CRYSTALS, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.GOBLIN_HOLDOUT, "§6King", 1, -1, 2),
    BAL(new ArrayList<Triple<Block, PropertyEnum, Comparable>>() {{
        ...
        add(new Triple<>(Blocks.barrier, null, null));
        add(new Triple<>(Blocks.barrier, null, null));
    }}, StructureType.CH_CRYSTALS, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.MAGMA_FIELDS, "§6Bal", 0, 1, 0),
    ...
    }}, StructureType.FAIRY_GROTTO, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.ANY, "", 0, 0, 0),
    ...
    }}, StructureType.CH_MOB_SPOTS, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.GOBLIN_HOLDOUT, "§6Goblin Hall", 0, 7, 0),
    ...
    }}, StructureType.CH_MOB_SPOTS, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.GOBLIN_HOLDOUT, "§6Goblin Ring", 0, 11, 0),
    ...
    }}, StructureType.CH_MOB_SPOTS, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.MITHRIL_DEPOSITS, "§bGrunt Bridge", 0, -1, -45),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.MITHRIL_DEPOSITS, "§bCorleone Dock",23,11,17),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.MITHRIL_DEPOSITS, "§bCorleone Hole",0,-3,34),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.MITHRIL_DEPOSITS, "§bGrunt Rails 1",0,0,0),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.MITHRIL_DEPOSITS, "§bGrunt Hero Statue",0,0,0),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.MITHRIL_DEPOSITS, "§bSmall Grunt Bridge",0,0,0),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.JUNGLE, "§aKey Guardian Spiral",0,0,0),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.JUNGLE, "§aSludge Waterfalls",0,0,0),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.JUNGLE, "§aSludge Bridges",0,0,0),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.MAGMA_FIELDS, "§6Yog Bridge",0,15,0),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.JUNGLE, "§aOdawa",0,0,0),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.JUNGLE, "§aMini Jungle Temple",0,0,0),
    PRECURSOR_TRIPWIRE_CHAMBER(new ArrayList<Triple<Block, PropertyEnum, Comparable>>() {{
        ...
        add(new Triple<>(Blocks.double_stone_slab, null, null));
        add(new Triple<>(Blocks.double_stone_slab, null, null));
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.PRECURSOR_REMNANTS, "§bPrecursor Tripwire Chamber",0,0,0),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.PRECURSOR_REMNANTS, "§bPrecursor Tall Pillars",0,0,0),
    ...
    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.GOBLIN_HOLDOUT, "§6Goblin Hole Camp",0,0,0),
    ...
    }}, StructureType.GOLDEN_DRAGON, LocationUtils.Island.CRYSTAL_HOLLOWS, CrystalHollowQuarter.ANY, "", 0, -3, 5);
...
//    }},StructureType.CH_MOB_SPOTS,LocationUtils.Island.CRYSTAL_HOLLOWS,"",23,11,17),
    ...
    private final CrystalHollowQuarter crystalHollowQuarter;
    ...
    public CrystalHollowQuarter getQuarter() {
        return this.crystalHollowQuarter;
    }
    ...
    Structure(ArrayList<Triple<Block, PropertyEnum, Comparable>> states, StructureType structureType, LocationUtils.Island island, CrystalHollowQuarter crystalHollowQuarter, String name, int xOffset, int yOffset, int zOffset) {
        this.states = states;
        this.structureType = structureType;
        this.island = island;
        this.crystalHollowQuarter = crystalHollowQuarter;
        this.name = name;
