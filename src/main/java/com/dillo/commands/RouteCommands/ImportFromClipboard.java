...
public class ImportFromClipboard extends Command {
    ...
    public static File createFile(String name) {
        ...
        if (name.contains(".json")) newRoute = new File(GetConfigFolder.getMcDir() + "/MiningInTwo/" + name);
        else newRoute = new File(GetConfigFolder.getMcDir() + "/MiningInTwo/" + name + ".json");
