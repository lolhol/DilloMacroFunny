...
public class MainHelp extends Command {
    ...
    public void handle() {
        ...
        SendChat.chat("/checkRoute -> WARNING! MAY LAG! This is a complicated process run /helpStructureCheck to see how works.");
        SendChat.chat("+++++++++++++++++++++");
        SendChat.chat("                                  ");
        ...
        SendChat.chat("/importRoute <name of new route> -> will attempt to make a new route with whatever you have in ur clipboard");
        SendChat.chat("/importFromWeb <link> <name of new route> -> WARNING! WORKS WITH ONLY PASTERBIN.COM. Does the same thing as /importRoute but from website.");
        SendChat.chat("+++++++++++++++++++++");
        SendChat.chat("                                  ");
        SendChat.chat("+++++ RouteClear +++++");
        SendChat.chat("/helperLines -> will display route-clear-help lines to help you clear legit (why is this here? just use /clearRouteLegit.");
        ...
        SendChat.chat("/addAccusation <detection> <answer> -> this will add an accusation to the list. AKA if player says something that contains (detection) then the macro will respond with (answer).");
        SendChat.chat("/removeAccusation <detection> -> will remove an accusation. Yes, u have to put the EXACT 'detection'.");
        SendChat.chat("                                  ");
        SendChat.chat("                                  ");
        SendChat.chat("------- Mining In Two help -------");
    }
