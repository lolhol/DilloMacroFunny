...
public class GetCurGemPrice {
    ...
    public static List<List<Double>> getCurrGemPrice() {
        ...
        List<String> gems = Arrays.asList("ROUGH_RUBY_GEM", "FLAWED_RUBY_GEM", "ROUGH_AMBER_GEM", "FLAWED_AMBER_GEM", "ROUGH_TOPAZ_GEM", "FLAWED_TOPAZ_GEM", "ROUGH_SAPPHIRE_GEM", "FLAWED_SAPPHIRE_GEM", "ROUGH_AMETHYST_GEM", "FLAWED_AMETHYST_GEM", "ROUGH_JASPER_GEM", "FLAWED_JASPER_GEM", "ROUGH_JADE_GEM", "FLAWED_JADE_GEM");
        String result;
