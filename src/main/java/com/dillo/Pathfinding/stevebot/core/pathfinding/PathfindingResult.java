...
public class PathfindingResult {
  ...
  public void log() {
    ...
    StevebotLog.log(
      "found path: " + pathFound + ", path=" + (finalPath == null ? "null" : finalPath.getClass().getSimpleName())
    );
    ...
    if (pathFound) {
      ...
      StevebotLog.log(
        ...
        nodesProcessed +
        "  (" +
        (((float) nodesConsidered / (float) nodesProcessed) * 100f) +
        "%)" +
        " -> discarded " +
        (nodesConsidered - nodesProcessed)
      );
      StevebotLog.log("");
      ...
      StevebotLog.log(
        ...
        actionsImpossible +
        "(" +
        (((float) actionsConsidered / (float) actionsImpossible) * 100f) +
        "%)"
      );
      StevebotLog.log(
        "actions (invalid): " +
        actionsInvalid +
        "(" +
        (((float) actionsConsidered / (float) actionsInvalid) * 100f) +
        "%)"
      );
      StevebotLog.log(
        "actions (unloaded): " +
        actionsUnloaded +
        "(" +
        (((float) actionsConsidered / (float) actionsUnloaded) * 100f) +
        "%)"
      );
      StevebotLog.log(
        "actions (valid): " + actionsValid + "(" + (((float) actionsConsidered / (float) actionsValid) * 100f) + "%)"
      );
      StevebotLog.log(
        "actions (created): " +
        actionsCreated +
        "(" +
        (((float) actionsConsidered / (float) actionsCreated) * 100f) +
        "%)"
      );
    }
    StevebotLog.log("==================");
  ...
  public void logConsole() {
    ...
    if (pathFound) {
      ...
      StevebotLog.logNonCritical(
        ...
        nodesProcessed +
        "  (" +
        (((float) nodesProcessed / (float) nodesConsidered) * 100f) +
        "%)" +
        " -> discarded " +
        (nodesConsidered - nodesProcessed)
      );
      ...
      StevebotLog.logNonCritical(
        ...
        actionsImpossible +
        "(" +
        (((float) actionsImpossible / (float) actionsConsidered) * 100f) +
        "%)"
      );
      StevebotLog.logNonCritical(
        "   actions (invalid): " +
        actionsInvalid +
        "(" +
        (((float) actionsInvalid / (float) actionsConsidered) * 100f) +
        "%)"
      );
      StevebotLog.logNonCritical(
        "  actions (unloaded): " +
        actionsUnloaded +
        "(" +
        (((float) actionsUnloaded / (float) actionsConsidered) * 100f) +
        "%)"
      );
      StevebotLog.logNonCritical(
        "     actions (valid): " +
        actionsValid +
        "(" +
        (((float) actionsValid / (float) actionsConsidered) * 100f) +
        "%)"
      );
      StevebotLog.logNonCritical(
        "   actions (created): " +
        actionsCreated +
        "(" +
        (((float) actionsCreated / (float) actionsConsidered) * 100f) +
        "%)"
      );
    }
    StevebotLog.logNonCritical("==================");
