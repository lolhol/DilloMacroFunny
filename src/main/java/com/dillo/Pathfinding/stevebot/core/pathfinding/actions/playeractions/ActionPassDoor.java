...
public class ActionPassDoor extends Action {
  ...
  private abstract static class PassDoorActionFactory implements ActionFactory {

    ActionPassDoor create(Node node, Direction direction, Result result) {
      return new ActionPassDoor(
        node,
        result.to,
        node.getPosCopy().add(direction.dx, 0, direction.dz),
        direction,
  ...
  private abstract static class AbstractPassDoorActionFactory extends PassDoorActionFactory {
