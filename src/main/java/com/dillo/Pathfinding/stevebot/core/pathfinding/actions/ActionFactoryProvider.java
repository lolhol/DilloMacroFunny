...
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionBridgeFree;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionDigDown;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionDropDown;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionEnterWater;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionExitWater;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionFall;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionJump;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionMineDown;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionMineStraight;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionMineUp;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionPassDoor;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionPillarUp;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionPillarUpMine;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionSprintJump;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionStepDown;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionStepUp;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionSwim;
import com.dillo.Pathfinding.stevebot.core.pathfinding.actions.playeractions.ActionWalk;
...
public class ActionFactoryProvider {
  ...
  public ActionFactoryProvider() {
    ...
    impossibleActionHandler.makesImpossible(
      ActionWalk.class,
      ActionSwim.class,
      ActionStepUp.class,
    ...
    impossibleActionHandler.makesImpossible(ActionFall.class, ActionDigDown.class);
    ...
    impossibleActionHandler.makesImpossible(ActionPillarUp.class, ActionPillarUpMine.class);

    // pillar mine
    registerFactory(new ActionPillarUpMine.PillarUpMineFactory());

    impossibleActionHandler.makesImpossible(ActionPillarUpMine.class, ActionPillarUp.class);

    // dig down
    registerFactory(new ActionDigDown.DigDownFactory());

    impossibleActionHandler.makesImpossible(ActionDigDown.class, ActionFall.class);
