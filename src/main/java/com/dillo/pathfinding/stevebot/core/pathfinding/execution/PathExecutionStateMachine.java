...
public class PathExecutionStateMachine
  extends StateMachine<PathExecutionStateMachine.ExecutionState, PathExecutionStateMachine.ExecutionTransition> {
  ...
  public PathExecutionStateMachine() {
    ...
    defineTransition(
      ...
      ExecutionTransition.START_FOLLOW,
      ExecutionState.WAITING_FOR_SEGMENT
    );
    defineTransition(
      ExecutionState.WAITING_FOR_SEGMENT,
      ExecutionTransition.SEGMENT_CALCULATED,
    ...
    defineTransition(
      ExecutionState.FOLLOWING,
      ExecutionTransition.REACHED_END_OF_SEGMENT,
      ExecutionState.WAITING_FOR_SEGMENT
    );
