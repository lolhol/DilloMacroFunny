...
public interface OpenGLAdapter {
     ...
     * Start drawing lines.
     *
     * @param lineWidth the width of the lines in pixels.
     */
     ...
     *
     * @param lineWidth the width of the line-strips in pixels.
     */
     ...
     * Start drawing boxes.
     *
     * @param lineWidth the width of the outline in pixels.
     */
