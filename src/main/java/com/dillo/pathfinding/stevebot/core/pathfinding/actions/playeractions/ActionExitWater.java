...
public class ActionExitWater extends Action {
    ...
    private abstract static class ExitWaterActionFactory implements ActionFactory {
    ...
    public abstract static class AbstractExitWaterActionFactory extends ExitWaterActionFactory {
