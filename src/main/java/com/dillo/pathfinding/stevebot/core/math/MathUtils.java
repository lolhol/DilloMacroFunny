package com.dillo.pathfinding.stevebot.core.math;

import com.dillo.pathfinding.stevebot.core.math.vectors.vec2.IVector2;
import com.dillo.pathfinding.stevebot.core.math.vectors.vec2.Vector2d;
import com.dillo.pathfinding.stevebot.core.math.vectors.vec2.Vector2f;
import com.dillo.pathfinding.stevebot.core.math.vectors.vec3.Vector3d;
import com.dillo.pathfinding.stevebot.core.math.vectors.vec3.Vector3f;
...
public class MathUtils {
    ...
    /**
     * @return true, if an is nearly equal to b.
     */
    ...
    /**
     * @return true, if an is nearly equal to b. Set "dynamicEpsilon" to true, to calculate the threshold for each pair of values.
     */
    ...
    /**
     * @return true, if an is nearly equal to b. Uses the given epsilon as a threshold
     */
