...
public class ActionUtils {
    ...
    /**
     * The Block below can not be walkable, and there must be a 3-block high space.
     *
     * @param pos the {@link BaseBlockPos}
    ...
    /**
     * The Block below must be walkable and there must be a 3-block high space.
     *
     * @param pos the {@link BaseBlockPos}
     * @return whether the player can jump at the given position
     */
    ...
    /**
     * The Block below must be walkable and there must be a 2-block high space.
     *
     * @param pos the {@link BaseBlockPos}
    ...
    /**
     * The Block below must be walkable, and there must be a space with the given height.
     *
     * @param pos    the {@link BaseBlockPos}
     * @param height the number of blocks to check above
     * @return whether the player can stand at the given position
    ...
    /**
     * The Block below must be non-flowing water, and there must be a 2-block high space.
     *
     * @param pos the {@link BaseBlockPos}
    ...
    public static BreakBlockCheckResult checkBlockToBreak(BaseBlockPos blockPos) {
        final ItemWrapper bestTool = PlayerUtils
                .getActiveSnapshot()
                .findBestToolForBlock(BlockUtils.getBlockProvider().getBlockAt(blockPos));
