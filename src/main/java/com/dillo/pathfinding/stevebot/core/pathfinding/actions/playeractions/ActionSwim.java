...
public class ActionSwim extends Action {
    ...
    private abstract static class SwimActionFactory implements ActionFactory {
    ...
    private abstract static class AbstractSwimActionFactory extends SwimActionFactory {
