...
import com.dillo.pathfinding.stevebot.core.math.vectors.vec3.Vector3l;
...
public class Vector4l implements IVector4 {
    ...
    public static Vector4l createVectorAB(IVector4 a, IVector4 b) {
        return Vector4l.createVectorAB(
                a.getLongX(),
                a.getLongY(),
                a.getLongZ(),
                a.getLongW(),
     ...
     * @return the vector "dst" with the new values
     */
    public static Vector4l setVectorAB(
            long ax,
            long ay,
            long az,
            long aw,
