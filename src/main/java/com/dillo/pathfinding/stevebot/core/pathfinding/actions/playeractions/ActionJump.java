...
public class ActionJump extends Action {
    ...
    private abstract static class JumpActionFactory implements ActionFactory {
    ...
    private abstract static class AbstractJumpActionFactory extends JumpActionFactory {
