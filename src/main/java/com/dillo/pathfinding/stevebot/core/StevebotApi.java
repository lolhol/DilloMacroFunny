package com.dillo.pathfinding.stevebot.core;
...
import com.dillo.pathfinding.stevebot.core.pathfinding.PathfindingResult;
import com.dillo.pathfinding.stevebot.core.pathfinding.actions.ActionObserver;
import com.dillo.pathfinding.stevebot.core.pathfinding.goal.ExactGoal;
import com.dillo.pathfinding.stevebot.core.pathfinding.goal.Goal;
import com.dillo.pathfinding.stevebot.core.pathfinding.goal.XZGoal;
import com.dillo.pathfinding.stevebot.core.pathfinding.goal.YGoal;
import com.dillo.pathfinding.stevebot.core.pathfinding.path.PathRenderable;
...
public class StevebotApi {
  ...
  public void pathBlock(String blockName, boolean startFollowing, boolean enableFreelook) {
    if (PlayerUtils.hasPlayer()) {
      final BaseBlockPos from = PlayerUtils.getPlayerBlockPos();
      final BaseBlockPos posBlock = BlockUtils.findNearest(
        BlockUtils.getBlockLibrary().getBlockByName(blockName),
        from,
        219,
        219
      );
