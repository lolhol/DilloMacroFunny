...
public class StevebotLog {
    ...
    /**
     * Sends the message to the player chat (if possible) and to the (logger) of this mod.
     *
    ...
    /**
     * Sends the message to the player chat (if possible) and to the (logger) of this mod only if {@code Config.isVerboseMode()} is true.
     *
     * @param message the message to log
     */
     ...
     *
     * @param message  the message to log
     * @param critical set too false to not send the message if {@code Config.isVerboseMode()} is false
     */
