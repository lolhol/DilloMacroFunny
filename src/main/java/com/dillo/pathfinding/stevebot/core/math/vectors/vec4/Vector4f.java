package com.dillo.pathfinding.stevebot.core.math.vectors.vec4;
...
public class Vector4f implements IVector4 {
  ...
  public static Vector4f createVectorAB(IVector4 a, IVector4 b) {
    return Vector4f.createVectorAB(
      a.getFloatX(),
      a.getFloatY(),
      a.getFloatZ(),
      a.getFloatW(),
   ...
   * @return the created vector
   */
  public static Vector4f createVectorAB(
    float ax,
    float ay,
    float az,
    float aw,
   ...
   * @return the vector "dst" with the new values
   */
  public static Vector4f setVectorAB(
    float ax,
    float ay,
    float az,
    float aw,
