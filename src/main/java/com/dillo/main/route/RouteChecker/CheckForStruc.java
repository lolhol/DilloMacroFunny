package com.dillo.main.route.RouteChecker;

import com.dillo.gui.GUIUtils.CheckRoute.GetFailPointsList;
import com.dillo.gui.GUIUtils.MatchServer.MatchTimeDate;
...
import static com.dillo.config.config.isAbleToTeleportChecks;
import static com.dillo.config.config.untouched;
import static com.dillo.gui.GUIUtils.MatchServer.IsChecked.isChecked;
import static com.dillo.gui.Overlay.isStartRenderPoints;
...
public class CheckForStruc {
    ...
    // "mcmod.info" file and adding the name "godbrigero" (and maybe add potato aka tato to credits too) to the #credits thing.
    // If you do not do this... I will be VERY mad and will have to take your penis rights
    // By cutting it off.

    // I'm actually serious. Add me to the #credits.
